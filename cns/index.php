...
$share_title = ($name)?"【{$name}】催奶师证":"催奶师生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/cns/?name='.$name.'&id='.$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>催奶师生成器-<?php echo $from_title;?></title>
...
<div class="wrapper">
	<img src="cns.php?name=<?=$_GET['name']?>" width="100%"/>
</div>
<?php }else{ ?>
