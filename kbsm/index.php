...
$share_title = ($name)?"【{$name}】的科比素描":"科比素描生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/kbsm/?name='.$name.'&id='.$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>科比素描生成器-<?php echo $from_title;?></title>
...
<div class="wrapper">
	<img src="kbsm.php?name=<?=$_GET['name']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
