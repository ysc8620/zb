...
$share_title = '愚人节孕检报告生成器';
$name = htmlspecialchars(trim($_GET['name']));
$share_title = ($name)?"【{$name}】的孕检报告":"愚人节孕检报告生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/yjx/?name='.$name.'&id='.$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
	<img src="yjx.php?name=<?=$_GET['name']?>&id=<?=$_GET['id']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
