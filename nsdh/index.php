...
$share_title = '女神男神来电话了生成器';
$name = htmlspecialchars(trim($_GET['name']));
$share_title = ($name)?"【{$name}】的女神男神来电话了":"女神男神来电话了生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/nsdh/?name='.$name.'&id='.$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>女神男神来电话了生成器-<?php echo $from_title;?></title>
...
<div class="wrapper">
	<img src="nsdh.php?name=<?=$_GET['name']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
