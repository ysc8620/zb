...
<title>疾病诊断书生成器-<?php echo $from_title;?></title>
...
<div class="wrapper">
	<img src="jb.php?name=<?=$_GET['name']?>&jb=<?=$_GET['jb']?>&uname=<?=$_GET['uname']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
	...
	<div class="ui-form">
    	<form action="">
			...
			<div class="ui-form-item ui-border-b">
            	...
            	<input type="text" name="uname" placeholder="输入你的姓名"/>
        	</div>
