...
$share_title = '亲子鉴定生成器';
$name = htmlspecialchars(trim($_GET['nametaobao']));
$share_title = ($name)?"【{$name}】的亲子鉴定":"亲子鉴定生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/qzjd/?nametaobao='.$name.'&namebjlm123='.$_GET['namebjlm123'].'&sex='.$_GET['sex'].'&checkResult='.$_GET['checkResult'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>亲子鉴定生成器-<?php echo $from_title;?></title>
...
<div class="wrapper">
	<img src="qzjd.php?nametaobao=<?=$_GET['nametaobao']?>&namebjlm123=<?=$_GET['namebjlm123']?>&checkResult=<?=$_GET['checkResult']?>&sex=<?=$_GET['sex']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
