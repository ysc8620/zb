...
$share_title = '最牛X的信用卡生成器';
$name = htmlspecialchars(trim($_GET['name']));
$share_title = ($name)?"【{$name}】的最牛X的信用卡":"最牛X的信用卡生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/zhao/?name='.$name.'&id='.$_GET['id'].'&namea='.$_GET['namea'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
