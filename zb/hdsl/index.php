...
$share_title = '轰动山林装逼神器生成器';
$name = htmlspecialchars(trim($_GET['name']));
$share_title = ($name)?"【{$name}】的轰动山林装逼神器":"轰动山林装逼神器生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/hdsl/?name='.$name.'&id='.$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
	<img src="hdsl.php?name=<?=$_GET['name']?>&id=<?=$_GET['id']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
