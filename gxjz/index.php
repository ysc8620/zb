...
$share_title = ($name)?"【{$name}】的搞笑奖状":"搞笑奖状生成器,由{$from_title}提供";
$share_link = "http://{$_SERVER[HTTP_HOST]}".'/gxjz/?name='.$name.'&id='.$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
	<img src="gx.php?name=<?=$_GET['name']?>&id=<?=$_GET['id']?>" width="100%"/>
</div>
<?php }else{ ?>
<div class="wrapper">
